...
export interface TransactionApi {
    ...
    /**
     * Sends fruits to another account/recipient
     *
     ...
     *
     * Usually, you don't need this, as all sending methods in FruitsJS sign and broadcast.
     * As not all BRS API functions are implemented yet in FruitsJS this method is handy for those,
