import { HttpMockBuilder, Http } from '@fruitsjs/http';
...
import { Amount, FeeQuantPlanck } from '@fruitsjs/util';
    ...
    describe('placeAskOrder', () => {
        it('should placeAskOrder', async () => {
            ...
            const { transaction } = await placeAskOrder(service)({
                ...
                asset: '123',
                quantity: 100,
                pricePlanck: Amount.fromFruit(10).getPlanck(),
