...
exports.sendAmountToSingleRecipient = (service) => (args) => __awaiter(void 0, void 0, void 0, function* () {
    let parameters = {
    ...
    const { unsignedTransactionBytes: unsignedHexMessage } = yield service.send('sendMoney', parameters);
...
//# sourceMappingURL=sendAmountToSingleRecipient.js.map