...
exports.createSubscription = (service) => (args) => __awaiter(void 0, void 0, void 0, function* () {
    let parameters = {
    ...
    const { unsignedTransactionBytes: unsignedHexMessage } = yield service.send('sendMoneySubscription', parameters);
