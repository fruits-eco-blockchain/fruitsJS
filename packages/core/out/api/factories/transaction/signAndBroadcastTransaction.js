...
exports.signAndBroadcastTransaction = (fruitsService) => (unsignedTransaction) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return broadcastTransaction_1.broadcastTransaction(fruitsService)(signedMessage);
});
