...
exports.cancelOrder = (service) => (args) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { unsignedTransactionBytes: unsignedHexMessage } = yield service.send(method, parameters);
