 ...
 * Modified work Copyright (c) 2021 Fruit Eco Blockchain
 */
...
/**
 * Creates a deeplink according the [CIP22 spec](https://github.com/fruits-apps-team/CIPs/blob/master/cip-0022.md)
 *
 ...
 * can redirect to the "Send Fruits" screen a fill out the form according the passed payload.
 *
